...
import com.example.onboarding_ui.adapter.GenderAdapter
import com.example.onboarding_ui.databinding.FragmentBottomSheetSelectionBinding
import com.google.android.material.bottomsheet.BottomSheetDialogFragment
import java.util.Calendar

class BottomSheetSelection() : BottomSheetDialogFragment() {

    private var _binding: FragmentBottomSheetSelectionBinding? = null
    ...
    companion object {
        fun newInstance(selection: String, initialValue: String?, callback: (String) -> Unit): BottomSheetSelection {
            return BottomSheetSelection().apply {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentBottomSheetSelectionBinding.inflate(inflater, container, false)
